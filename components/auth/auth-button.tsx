...
const LOGIN_PATH = ROUTE_PATH.LOGIN;
...
export default function AuthButton() {
  ...
  if (user) {
    return (
      <Button variant="destructive" onClick={handleLogout} className="rounded-full cursor-pointer">
        <span>Đăng xuất</span>
  ...
  return (
    <Button
      className="group hover:bg-primary/10 hover:text-primary rounded-full cursor-pointer"
