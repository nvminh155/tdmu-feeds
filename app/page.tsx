        ...
        <div className="container mx-auto px-4 py-24 md:py-32 lg:py-40">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl text-pretty">
              Nền tảng tổng hợp tin tức từ các câu lạc bộ, tổ chức và đoàn thể
              trong trường. Không bỏ lỡ bất kỳ sự kiện hay thông tin quan trọng
              nào.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4  z-10">
              ...
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto z-2 px-8 bg-transparent"
                asChild
              >
            ...
            {[
              {
                ...
                description:
                  "Tự động thu thập tin tức từ các fanpage và trang chính thức của câu lạc bộ.",
              },
              {
                icon: Bell,
                title: "Thông báo thông minh",
                description:
                  "Nhận thông báo khi có tin tức mới từ các câu lạc bộ bạn yêu thích.",
              },
              {
                icon: Heart,
                title: "Yêu thích & Lưu trữ",
                description:
                  "Lưu lại các bài viết quan trọng để đọc sau hoặc chia sẻ với bạn bè.",
              },
              {
                icon: Users,
                title: "Cộng đồng đa dạng",
                description:
                  "Kết nối với hơn 10 câu lạc bộ và tổ chức trong trường.",
              },
              {
                icon: Zap,
                title: "Cập nhật nhanh chóng",
                description:
                  "Tin tức được cập nhật liên tục, đảm bảo bạn không bỏ lỡ điều gì.",
              },
              {
                icon: Globe,
                title: "Truy cập mọi nơi",
                description:
                  "Giao diện tối ưu cho mọi thiết bị, từ điện thoại đến máy tính.",
              },
            ].map((feature) => (
              <div
                key={feature.title}
          ...
          <div className="relative overflow-hidden rounded-3xl bg-primary px-8 py-16 md:px-16 md:py-24">
            ...
            <div className="relative mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-lg text-primary-foreground/80">
                Tham gia ngay để không bỏ lỡ bất kỳ tin tức nào từ các câu lạc
                bộ yêu thích của bạn.
              </p>
              <div className="mt-8">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground max-w-md">
                Nền tảng tổng hợp tin tức từ các câu lạc bộ và tổ chức thuộc Đại
                học Thủ Dầu Một. Giúp sinh viên cập nhật thông tin nhanh chóng
                và tiện lợi.
              </p>
            </div>
